...
public class EmailTemplate {
    ...
    public String getResetPassword(){
        ...
        return "<!doctype html>\n" +
               ...
               "<meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\" />\n" +
                ...
                "<p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "If this action wasn’t done by you, please contact us on <b>yudiansyahfauzi@gmail.com</b>. But if it’s you, you can ignore this message. </p>" +
                "</td>\n"+
                "</tr>\n"+
                "<tr>\n" +
                "<td style=\"height:40px;\">&nbsp;</td>" +
    ...
    public String RejectEmail(){
        return "<!doctype html>\n" +
                ...
                "                <p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "               Please try again and make sure to input the right transfer receipt before you make your order. If there’s any problem you can contact us on <b>yudiansyahfauzi@gmail.com</b>.</p>\n" +
                "                </td>\n" +
                "                </tr>\n" +
                "                <tr> \n" +
                "                <td style=\"height:40px;\">&nbsp;</td>\n" +
    ...
    public String verifyUser(){
        return "<!doctype html>\n" +
                ...
                "If there’s any problem you can contact us on <b>yudiansyahfauzi@gmail.com</b>.\n" +
                "</p>\n"+
                "                </td>\n" +
                "                </tr>\n" +
                "                <tr> \n" +
    ...
    public String getTalentAcc(){
        return "<!DOCTYPE html>\n" +
                ...
                "    <h2 class=\"w3-wide\"><b>Welcome to chute!</b></h2> \n" +
                "    <p class=\"w3-justify\">Hi {{USERNAME}},</p>\n" +
                "    <p class=\"w3-justify\">Thank you for registering with chute. The purpose of this email is to ensure we have your email address.</p>\n" +
                "    <p class=\"w3-justify\">Tap button down below to active our account by click.</p>\n" +
                "</br>  \n" +
                "    <p><button class=\"w3-button w3-black w3-round-large\"><a href=\"{{VERIF_LINK}}\">Active your account</a> </button></p>\n" +
                "    </br>  \n" +
                "    <p class=\"w3-justify\">Happy selling and buying.</p>\n" +
                "    <p class=\"w3-justify\"><b>Chute app team</p></p>\n" +
                "        <h2 class=\"w3-wide w3-center\"><b>CHUTE</b></h2>\n" +
                "        <i class=\"fa fa-twitter w3-hover-opacity\" style=\"padding-right: 10px;\"></i>\n" +
                "        <i class=\"fa fa-instagram w3-hover-opacity\"  style=\"padding-right: 10px;\"></i>\n" +
                "        <i class=\"fa fa-facebook-official w3-hover-opacity\" style=\"padding-right: 10px;\"></i>\n" +
                "         \n" +
                "  </div>\n" +
                "\n" +
                "  <!-- The Tour Section -->\n" +
                "  <div class=\"\" style=\"background-color: black;\" id=\"tour\">\n" +
                "    <div class=\"\" style=\"max-width:800px; color: white; font-size: 10pt; font-weight: normal; padding: 10px;\">\n" +
                "      <p   >Make sure you don't miss out on the newest listing and latest price drops.</p>\n" +
                "      <p>You can unsubscribe from receiving these emails by editing your Chute notification settings.</p>\n" +
                "      <p>All Chute services are suject to our Privacy & Cookies Policy and Term & Conditions.</p>\n" +
                "      <p>By using our services you agree ti these.</p>\n" +
                "      <p>These services are operated and provided by Chute tech ltd.</p>\n" +
                "    </div>\n" +
                "  </div> \n" +
                "</body>\n" +
                "</html>\n";
